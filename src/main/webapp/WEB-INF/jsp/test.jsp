...
<head>
    ...
    <title>500 error page with particles - Bootdey.com</title>
    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                ...
                <span class="inner-status" style="font-size: 20px;color:rgb(45, 45, 45);">Oops! Looks like our Server is on Break!</span>
                <span class="inner-detail" style="color:#fff;font-size: 15px;">
